...
class countriesController extends Controller{
	...
	*/
	public function index($request, $response,  $args){
            ...
            return $this->view->render($response,'countries/index.twig', 
			['countries'=>$countries]);
	...
	*/
	public function view($request, $response, $args){
		...
		return $this->view->render($response,'countries/view.twig',
		 ['country'=>$country]);
	...
	*/
	public function edit($request, $response,  $args){
			...
			return $this->view->render($response,'countries/edit.twig', 
			['country'=>$country]);
		...
		if($validation->failed()){
            ...
            if($country){
                ...
                //redirect to eg. countries/view/8 
                return $response->withRedirect($this->router->pathFor('countries.view',
				 ['id'=>$country->id]));
            }
        }
		return $this->view->render
		($response,'countries/edit.twig');
